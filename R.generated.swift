...
struct _R {
  ...
  struct image {
    ...
    /// Image `icon_alphabat_del`.
    var icon_alphabat_del: RswiftResources.ImageResource { .init(name: "icon_alphabat_del", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
